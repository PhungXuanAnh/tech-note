...
- [Hướng dẫn cài đặt Nagios Core trên Ubuntu 16.04](#hướng-dẫn-cài-đặt-nagios-core-trên-ubuntu-1604)
    - [Table of contents](#table-of-contents)
    - [1. Chuẩn bị](#1-chuẩn-bị)
        - [1.1 Chuẩn bị môi trường cài đặt](#11-chuẩn-bị-môi-trường-cài-đặt)
        - [1.2 Tạo user cho Nagios](#12-tạo-user-cho-nagios)
    - [2. Cài đặt Nagios](#2-cài-đặt-nagios)
        - [2.1 Cài đặt Nagios Core và Plugin](#21-cài-đặt-nagios-core-và-plugin)
        - [2.2 Cài đặt NRPE](#22-cài-đặt-nrpe)
        - [2.3 Khởi động Nagios Server](#23-khởi-động-nagios-server)
        - [2.4 Cấu hình giám sát 1 host Linux](#24-cấu-hình-giám-sát-1-host-linux)
        - [2.5 Giám sát MySQL](#25-giám-sát-mysql)
        - [2.6 Giám sát RabbitMQ](#26-giám-sát-rabbitmq)
