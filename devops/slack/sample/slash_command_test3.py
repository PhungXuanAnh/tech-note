...
def test3():
    ...
    return jsonify(text="hello ! this is repsonse from api server after get your test3 command. I'm doing what you want.."), 200    # this message will be show Only visible to you
